...
After exploring the dataset, the only variable with an anomaly is burn days with negative values, this represent the duration of burn in days and we do not expect to have values below zero. 
...
In summary, neither year nor month are relevant variables in order to estimate the number of acres burned in a fire incident.
