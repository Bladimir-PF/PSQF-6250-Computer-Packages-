...
Images are similar ![wsdasd](plot4.jpg)
...
veg <- data.frame(cbind(
  country <- c('U.S', 'Denmark', 'Taiwan', 'Japan', 'Italy', 'Thailand', 'Others'),
...
colnames(veg) <- c('country', 'veg_2012_13', 'veg_2013_14', 'veg_2014_15', 'fruit_2012_13', 'fruit_2013_14', 'fruit_2014_15')

veg_long <- veg %>%
  pivot_longer(veg_2012_13:fruit_2014_15, names_to = 'veg_fruit', values_to = 'imp')%>%
  separate(veg_fruit, into = c('type', 'year', 'month'), sep = '_')
veg_long

ggplot(veg_long, aes(country, imp))+
  geom_point(aes(color = type, shape = month))+
  facet_wrap(~year)
```
