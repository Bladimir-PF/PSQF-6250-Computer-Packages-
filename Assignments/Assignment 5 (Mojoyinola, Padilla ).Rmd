...
3. Given the function created in #1, let’s add a function argument to the function. Add a function argument that allows users to control whether sampling with replacement or without replacement is performed.
